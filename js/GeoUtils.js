...
(function() { 
 ...
 82      */
    ...
    GeoUtils.IsPointOnPolyline2 = function (point, points) {
        ...
        for (var i = 0; i < pts.length - 1; i++) {
            ...
            var x=point.lng;
            var y=point.lat;
            var CompWidth=0.0065;
            if(x1==x2){
                if(y1<y2&&y>y1&&y<y2&&x>x1-CompWidth&&x<x1+CompWidth){
                    return true;
                }
                if(y1>y2&&y>y2&&y<y1&&x>x1-CompWidth&&x<x1+CompWidth){
                    return true;
                }
            }
            if(x1<x2&&(x<x1||x>x2)){
            ...
            if(x1!=x2){
                var k=(y2-y1)/(x2-x1);
                var kt=-1.0/k;
                var xt=((y-y2-kt*x+k*x2)/(k-kt));
                var yt=(y-kt*(x-xt));
                var d=Math.sqrt((yt-y)*(yt-y)+(xt-x)*(xt-x));
                if(d<CompWidth){
                   return true;
                }
            }
